...
<p>Finally nailed the arrangement on the track I've been calling "Sunday," the slow one with the tape-saturated chords that I've been circling back to since November. It's done now. Or I'm stopping before I ruin it, which is the same thing. Six minutes, mostly space, a bassline that enters halfway through and completely changes the mood. Played it to a friend and she said it sounded like "the last song at a party you don't want to leave." I'll take it.</p>
...
<p>Best find of the week: snow falling off a roof onto the street. A heavy thud and then this crystalline scatter as it breaks apart. I got about a dozen of these and dropped two of them straight into a new track as percussion. Also recorded my boots on different surfaces. Packed snow at minus twenty sounds almost like a snare hit, sharp and dry. Building a whole kit from winter walking sounds. Frostbitten fingers, worth it.</p>`,
  ...
  {
    id: 54,
    title: 'Theo Parrish on RA Exchange',
    timestamp: '2026-02-23T21:30',
    contentType: 'link',
    category: 'recommendation',
    body: `<p>Came back to this Theo Parrish RA Exchange interview again. I first listened back in September but it keeps pulling me in. He talks about records and production and the politics of the music in a way that feels genuinely personal, not rehearsed. Every time I re-listen I catch something I missed.</p>
<p>February has been quiet and cold. Not going out much, just working on stuff at home. Good company for late evenings with headphones on.</p>
<br /><iframe title="RA Exchange — EX.763 Theo Parrish" width="100%" height="166" scrolling="no" allow="autoplay" src="https://w.soundcloud.com/player/?url=https%3A//soundcloud.com/ra-exchange/ex763-theo-parrish&color=%23e8d44d&auto_play=false&hide_related=true&show_comments=false&show_user=true&show_reposts=false&show_teaser=false" loading="lazy"></iframe>`,
    avatarColor: '#2e2e3e',
    author: 'Random Gorsey',
    tags: ['recommendation', 'february', '2026', 'theo-parrish', 'ra-exchange'],
  },
];
