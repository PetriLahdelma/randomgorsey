...
<p>The shape of something is forming. Too early to say what.</p>`,
  ...
  },
  {
    id: 40,
    title: 'Slush Week',
    timestamp: '2025-11-10T18:15',
    contentType: 'text',
    category: 'scene',
    body: `<p>The city gets strange during Slush week. Packed hotels, full restaurants, people from everywhere wandering around looking slightly lost. I have nothing to do with the startup world but the side effect is the whole city feels more alive than it does in a normal November.</p>
<p>Caught a Tuesday night somewhere that was way more packed than you'd expect for a weekday. Good energy, a mix of regulars and conference visitors, nobody being weird about it. Helsinki in November is not what outsiders expect. Dark, yes. Cold, yes. But properly alive indoors. The cultural calendar is stacked and everyone's leaning into the season instead of fighting it. I find that genuinely nice to be around.</p>`,
    avatarColor: '#2a1a3e',
    author: 'Random Gorsey',
