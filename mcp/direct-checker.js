    ...
    try {
      switch (command) {
        case 'check':
          ...
          const typeResult = await checker.checkTypes({ strict: args.includes('--strict') });
          console.log(typeResult.success ? '✅' : '❌', typeResult.message);
        ...
        case 'lint':
          ...
          const lintResult = await checker.lint({ fix: args.includes('--fix') });
          console.log(lintResult.success ? '✅' : '❌', lintResult.message);
        ...
        case 'analyze':
          ...
          const analyzeResult = await checker.analyzeFile(path.resolve(filePath));
          console.log(analyzeResult.success ? '✅' : '❌', analyzeResult.message);
        ...
        case 'all':
          ...
          const allSuccess = results.typeCheck && results.linting && results.structure;
